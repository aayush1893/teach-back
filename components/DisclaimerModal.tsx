    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4" role="dialog" aria-modal="true">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-2xl font-bold text-amber-600">Important Disclaimer</h2>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-800" aria-label="Close disclaimer modal">
        ...
        <div className="p-6 space-y-4 text-gray-700">
          ...
          <p className="text-red-600 font-bold">For emergencies, call your local emergency number immediately.</p>
