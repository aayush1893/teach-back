    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4" role="dialog" aria-modal="true">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 sticky top-0 bg-white border-b flex justify-between items-center">
          <h2 className="text-2xl font-bold text-blue-600">How to Use Teach-Back Engine</h2>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-800" aria-label="Close help modal">
        ...
        <div className="p-6 space-y-4 text-gray-700">
          ...
          <div>
           ...
           <div>
            <h3 className="font-semibold text-lg text-red-600">Limitations:</h3>
            <p className="text-red-600">This is an educational tool and not medical advice. If you have urgent symptoms (e.g., severe chest pain, trouble breathing, suicidal thoughts), call your local emergency number or seek immediate care.</p>
          </div>
        </div>
